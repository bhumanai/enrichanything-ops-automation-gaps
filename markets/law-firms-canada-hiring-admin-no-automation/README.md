...
```text
Find law firms in Canada with roughly 10 to 50 employees that are hiring admin staff, intake coordinators, or paralegals while showing little visible workflow automation. Return source-backed rows with company name, website, location, hiring signal, workflow gap, and why-now notes.
```
